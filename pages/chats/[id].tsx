  ...
  return (
    <Layout title="이름" canGoBack hasTabBar={false}>
      <div className="bg-slate-100 fixed w-full top-16 h-full overflow-auto pb-32">
        ...
        <form className="fixed h-16 bottom-0 inset-x-0 flex items-center border-t p-2 text-base bg-slate-100 z-10">
          <label className="grow rounded-full overflow-hidden shadow">
            <input className="w-full p-2 text-gray-600 px-6 pr-12" />
          </label>
