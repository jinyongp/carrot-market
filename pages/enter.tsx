...
export default function Enter() {
  ...
  return (
    <div className="py-8 h-screen sm:flex sm:justify-center sm:items-center">
      <div className="py-8 min-w-[500px] sm:py-16 sm:rounded-lg sm:shadow sm:shadow-slate-300">
        ...
        <div className="px-4">
          <div className="py-3 relative">
            ...
            <div className="grid grid-cols-2 border-b text-gray-600">
              <button
                className={`
                p-2 mx-5 border-b-4 transition
                ${
                  method === 'email'
